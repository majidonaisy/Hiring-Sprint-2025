 ...
 * Mock implementation for MVP - can be replaced with Hugging Face/Roboflow API
 */
...
/**
 * AI Service with mock implementation
 * Implements IAIProvider for use with provider registry
 */
...
export type { PhotoAnalysis, DetectedDamage };
